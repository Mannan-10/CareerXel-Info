...
export interface ApiContactMessageContactMessage
  ...
  attributes: {
    ...
    email: Schema.Attribute.Email;
    firstName: Schema.Attribute.String;
    interestType: Schema.Attribute.Enumeration<
      [
        'demo',
        'pricing',
        'support',
    ...
    statusType: Schema.Attribute.Enumeration<
...
export interface ApiGlobalSettingGlobalSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    linkedUrl: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPricingPlanPricingPlan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    priceAnnual: Schema.Attribute.String;
    priceMonthly: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    downloadFormat: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer;
    publichedDate: Schema.Attribute.Date;
    publishedAt: Schema.Attribute.DateTime;
    readTime: Schema.Attribute.String;
    resourceType: Schema.Attribute.Enumeration<
      ['article', 'dataset', 'playbook', 'webinar', 'guide', 'doc']
    >;
